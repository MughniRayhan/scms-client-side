...
const Location = () => {
  return (
    <section className="bg-white dark:bg-gray-900 py-16 px-4 sm:px-6 lg:px-20 my-8 rounded-2xl"  
    data-aos="fade-up" data-aos-duration="1000" >
     
        <h2 className="text-2xl sm:text-4xl font-extrabold text-center text-accent mb-2 dark:text-orange-400">Our <span className='text-primary dark:text-white'>Location</span></h2>
        <p className="text-center text-gray-700 mb-12 max-w-2xl mx-auto dark:text-gray-300 ">
        ...
        <div className="flex sm:flex-row flex-col lg:gap-10 gap-6 items-center justify-center w-[90%] mx-auto">
          ...
          <div className=' lg:w-1/2 w-full'>
            <h3 className="text-3xl font-bold text-secondary mb-4 dark:text-white">Address</h3>
